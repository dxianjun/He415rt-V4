...
#define		PWM_CLOCK_FSYS					PWMCON&=0xBF
...
#define Enable_ADC_BandGap		ADCCON0&=0xF0;ADCCON0|=0x08;AINDIDS=0x00;ADCCON1|=SET_BIT0												//Band-gap 1.22V
#define Disable_ADC_ALL			AINDIDS=0x00;ADCCON1=0
