...
sfr   INT0R   = 0xBB; 	//INT0 上升沿中断控制寄存器
sfr   INT1F   = 0xBC; 	//INT1 下降沿中断控制寄存器
sfr   INT1R   = 0xBD; 	//INT1 上升沿中断控制寄存器
sfr   INT2F   = 0xC6; 	//INT2 下降沿中断控制寄存器
sfr   INT2R   = 0xC7; 	//INT2 上升沿中断控制寄存器
...
sbit	IPT2	= IP^5;	  //Timer2中断优先控制位   0:设定 Timer2的中断优先权是 “低”		1:设定 Timer2的中断优先权是 “高”
sbit 	IPUART	= IP^4;	  //UART中断优先控制位	   0:设定 UART的中断优先权是 “低”			1:设定 UART的中断优先权是 “高”
sbit 	IPT1	= IP^3;	  //Timer1中断优先控制位   0:设定 Timer 1的中断优先权是 “低”		1:设定 Timer 1的中断优先权是 “高”	
sbit	IPINT1	= IP^2;   //INT1中断优先控制位	   0:设定 INT1中断优先权是 “低”		    1:设定 INT1的中断优先权是 “高”
sbit 	IPT0	= IP^1;	  //Timer0中断优先控制位   0:设定 Timer 0的中断优先权是 “低”		1:设定 Timer 0的中断优先权是 “高”
sbit	IPINT0	= IP^0;   //INT0中断优先控制位	   0:设定 INT0中断优先权是 “低”		    1:设定 INT0的中断优先权是 “高”
...
/******************* P0 ******************
*SC92F7352封装未引出的管脚：无
*SC92F7351封装未引出的管脚：P04/P05
*SC92F7350封装未引出的管脚：P0
******************************************/
sbit 	P07	= P0^7;
sbit 	P06	= P0^6;
sbit 	P05	= P0^5;
...
*SC92F7352封装未引出的管脚：无
*SC92F7351封装未引出的管脚：无
*SC92F7350封装未引出的管脚：P10/P11/P16/P17
******************************************/
sbit 	P17	= P1^7;
sbit 	P16	= P1^6;
sbit 	P15	= P1^5;
...
/******************* P2 ******************
*SC92F7352封装未引出的管脚：无
*SC92F7351封装未引出的管脚：P26/P27
*SC92F7350封装未引出的管脚：P24/P25
******************************************/
sbit 	P27	= P2^7;
sbit 	P26	= P2^6;
sbit 	P25	= P2^5;
